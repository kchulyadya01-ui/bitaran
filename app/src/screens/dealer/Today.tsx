      ...
      <div className="scroll">
        <div style={{ padding: 19, display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div style={{ display: 'flex', gap: 12 }}>
            <div style={{ flex: 1, background: '#ffcb4d', padding: 18, borderRadius: 18 }}>
              <div style={{ fontSize: 11, fontWeight: 500, color: 'rgba(0,0,0,0.55)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Orders today</div>
              <div className="num" style={{ fontSize: 34, fontWeight: 600, lineHeight: 1, marginTop: 4, color: '#000' }}>{data?.todaysOrders.length ?? 0}</div>
            </div>
